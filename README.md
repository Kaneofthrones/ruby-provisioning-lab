...
```
git clone git@github.com:Kaneofthrones/ruby-provisioning-lab.git 
cd ruby-provisioning-lab
vagrant up
...
on your browser, enter the following address: 
http://development.local:4567/
